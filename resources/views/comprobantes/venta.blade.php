    ...
    <div class="container">
                ...
                <td class="header-right">
                    ...
                    <div class="datos-right">
                        <p>
                          ...
                          No. <strong style="font-size: 20px;"> {{$sale->nro_documento}}</strong><br>
                          {{$sale->nro_autorizacion}}
                        </p>
                    </div>
                </td>
            </tr>
        ...
        <div class="content">
            <table style="width: 100%">
                <tr>
                  <td style="width: 50%;"><strong>Razón Social</strong> {{strtoupper($sale->customer->razonSocial)}}</td>
                  <td style="width: 30%;"><strong>CI/NIT:</strong> {{ strtoupper($sale->customer->ci_nit) }}</td>
                  <td style="width: 20%;"><strong>Fecha:</strong> {{ $sale->fecha_venta }}</td>
                </tr>
            </table>
            <table class="payment-table">
                ...
                <tfoot style="border: none;">
                  <tr>
                    ...
                    <td style="border: none; text-align: center;">{{ number_format($sale->iva, 2) }}</td>
                  </tr>
                  @if($sale->descuento > 0)
                  <tr>
                      <td colspan="2" style="border: none;"></td>
                      <td style="border: none; text-align: right;"><strong>Descuento Bs.</strong></td>
                      <td style="border: none; text-align: center;">{{ number_format($sale->descuento, 2) }}</td>
                  </tr>
                  @endif
                  <tr>
                    <td colspan="2" style="border: none;"></td>
                    <td style="border: none; text-align: right;"><strong>Total Bs.</strong></td>
                    <td style="border: none; text-align: center;">{{ number_format($sale->total, 2) }}</td>
                  </tr>
                </tfoot>
            </table>
        </div>
        ...
        <div class="signature-section">
          <div>
              ...
              <p>{{ strtoupper($sale->customer->razonSocial) }}</p>
          </div>
          <div>
              <p>______________________________</p>
              <p>CONTADORA</p>
