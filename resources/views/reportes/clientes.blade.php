    ...
    <div class="container">
        ...
        <div class="content">
            <table style="width: 100%">
                <tr>
                  @if ($customer)
                    <td style="width: 50%;"><strong>Cliente: </strong> {{$customer->razonSocial}}</td>
                  @endif
                  @if ($estado_pago)
                    <td style="width: 50%;"><strong>Estado: </strong> {{$estado_pago}}</td>
                  @endif
                </tr>
            </table>
            <table class="payment-table">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td style="width: 25%;">{{ $item->razonSocial ?? 'N/A' }}</td>
                      <td style="width: 5%;">{{ $item->estado_pago ?? 'N/A' }}</td>
                      <td style="width: 18%;">{{ $item->producto_nombre ?? 'N/A' }}</td>
                      <td style="width: 8%;">{{ $item->cantidad ?? 0 }}</td>
                      <td style="width: 12%;">{{ number_format($item->precio_unitario, 2) }}</td>
